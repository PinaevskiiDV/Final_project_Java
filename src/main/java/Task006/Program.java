...
public class Program {
    public static void main(String[] args) {
        Notebook HP230Ti15 = new Notebook("HP", "230T-i15", "Black", 15.6, "LCD", 8, 256, "SSD");
        ...
        List<Notebook> notebookList = List.of(HP230Ti15, SamsungS101, SamsungS150, AsusTUF504, AsusTUF555);
